...
import { useLocation } from '@/hooks/useLocation'; // Certifique-se de ter esse hook
...
export default function MainMenu() {
  ...
  const handleSosPress = () => {
    ...
    setTimeout(() => {
      setLoading(false);
      console.log('SOS concluído');
    }, 3000); // Simula um envio
  };
      ...
      <SafeAreaView style={styles.container}>
        ...
        <View style={{ flex: 1, paddingBottom: height * 0.08, justifyContent: "center" }}>
          ...
          <Text style={styles.subTitle}>
            Pressione o botão e buscaremos ajuda para você
          </Text>
